...
{
  public:
    Rack(int motorPin1,int motorPin2,int motorPin3,int motorPin4,int pwm1,int dir1,const uint8_t & buttonPin,const uint8_t & sensor);
    int motorSpeed,count,countsperrev,button,flag,step_count,buttonState,success,motorPin1,motorPin2,motorPin3,motorPin4,pwm1,dir1;;
    int lookup[8] = {B01000, B01100, B00100, B00110, B00010, B00011, B00001, B01001};
    char sensor,buttonPin;
    //Rack(byte motorPin1,byte motorPin2,byte motorPin3,byte motorPin4,byte pwm1,byte dir1,byte buttonPin,char sensor);                                                                                              //Used to control the motion of the stepper for the rack mechanism
    void Moverack();
...
Rack::Rack(int motorPin1,int motorPin2,int motorPin3,int motorPin4,int pwm1,int dir1,const uint8_t & buttonPin,const uint8_t & sensor)
{
  //sensor= sensor;
  //motorPin1=motorPin1;motorPin2=motorPin2;motorPin3=motorPin3;motorPin4=motorPin4;pwm1=pwm1;dir1=dir1;buttonPin=buttonPin;sensor=sensor;
